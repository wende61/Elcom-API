        ...
        public async Task<bool> UploadFileToSharePointOnlineAsync(FileConfig fileConfig)
        {
            try
            {
                using (var ctx = new AuthenticationManager()
                    .GetAzureADAppOnlyAuthenticatedContext(fileConfig.SiteUrl, "6fc0f5c0-62b7-4adb-9176-c1695defa6d2", "2c6a3169-d4de-4366-8e8b-7b6d7a42efcc",
                    @"c:\EthiopianAirlines.pfx", "Abcd@1234"))
                {
